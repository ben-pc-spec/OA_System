<template>
  <div>
    ...
    <!-- 卡片视图区 -->
    <el-card>
       <el-form :inline="true" :model="UserInfoForm" label-width="100px">
        ...
        <el-form-item label="部门">
          <el-input v-model="UserInfoForm.depart.name" disabled></el-input>
        </el-form-item>
        <el-form-item label="职位">
          <el-input v-model="UserInfoForm.post.name" disabled></el-input>
        </el-form-item>
        <el-form-item label="角色">
          <el-input v-model="UserInfoForm.role.name" disabled></el-input>
        </el-form-item>
        <br />
        <br />
        <el-form-item >
          <el-button type="primary" @click="editUserById">确认修改</el-button>
        </el-form-item>
      </el-form> 
    </el-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    async editUserById(){
      const{data:res} = await this.$http.put('users/',this.UserInfoForm)
      if(res.meta.status != 200) {
